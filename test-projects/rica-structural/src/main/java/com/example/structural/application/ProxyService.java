...
public class ProxyService {
    ...
    // RICA-V322 FIX:
    // Hide low-level DataSource access behind a repository, gateway, or proxy.
    // The service should call a stable abstraction instead of raw infrastructure.
    // Example fixed shape:
    //   orderRepository.processOrder();
    // where the repository owns DataSource/Connection handling.
    public void process(){
