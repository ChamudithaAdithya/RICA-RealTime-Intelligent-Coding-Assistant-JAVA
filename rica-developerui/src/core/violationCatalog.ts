...
export type CatalogStage = 'stage1' | 'stage2' | 'stage3' | 'stage4' | 'fallback';
export type CatalogConfigKey =
  | 'enableArchitecturalChecks'
  | 'enableDesignPatternChecks'
  | 'enableBusinessLogicChecks';

export interface SeverityContext {
  /** The emission context, e.g. "Tarjan SCC cycle vs inverted dependency". */
  context: string;
  severity: CatalogSeverity;
}

export interface ViolationDoc {
  /** Standardized code, e.g. 'RICA-V401'. */
  code: string;
  /** Short human name, e.g. 'Controller Bypass'. */
  name: string;
  /** Primary severity shown in the rule matrix. */
  severity: CatalogSeverity;
  /** Context-specific severities (V403, V404 emit more than one severity). */
  severityContexts?: SeverityContext[];
  /** Which analysis stage emits this code. */
  stage: CatalogStage;
  /** Human label of the stage. */
  stageLabel: string;
  /** Detector source identifier as it appears on violations. */
  detectorSource: string;
  /** Detector class / rule name. */
  detector: string;
  /** Layered-architecture layer(s) this rule is about. */
  layer: string;
  /** When the rule fires — plain-language, source-verified. */
  trigger: string;
  /** Architectural rationale (full paragraph). */
  whyItMatters: string;
  /** Ordered fix steps. */
  howToFix: string[];
  /** Minimal snippet that triggers the rule. */
  beforeCode?: string;
  /** Corrections from the fix steps. */
  afterCode?: string;
  /** Short mitigation hint — reused verbatim by the extension webview. */
  mitigationHint: string;
  /** Configuration setting that enables/disables this rule, if any. */
  configKey?: CatalogConfigKey;
  /** Related codes. */
  relatedRules: string[];
  /** Detector source location `src/xxx.ts:LINE`. */
  sourceRef: string;
  /** Searchable tags. */
  tags: string[];
}

const CATALOG_BY_CODE: Record<string, ViolationDoc> = {};

function d(entry: ViolationDoc): ViolationDoc {
...
public String lookup(long id) {
  ...
  sourceRef: 'src/analyzers/serviceLayerDetector.ts:120',
...
public class OrderService {
  ...
  sourceRef: 'src/analyzers/serviceLayerDetector.ts:44',
...
public class OrderController {
  ...
  sourceRef: 'src/analyzers/controllerLayerDetector.ts:116',
...
public class OrderService {
  ...
  sourceRef: 'src/analyzers/serviceLayerDetector.ts:141',
...
public void disableUser(long id) {
  ...
  sourceRef: 'src/analyzers/entityLayerDetector.ts:85',
...
public class Account {
  ...
  sourceRef: 'src/analyzers/entityLayerDetector.ts:246',
...
public class AuditLogRepository {
  ...
  sourceRef: 'src/analyzers/entityLayerDetector.ts:101',
...
public class PaymentController {
  ...
  sourceRef: 'src/analyzers/controllerLayerDetector.ts:199',
...
public class ExportController {
  ...
  sourceRef: 'src/analyzers/controllerLayerDetector.ts:210',
...
public class NotificationController {
  ...
  sourceRef: 'src/analyzers/controllerLayerDetector.ts:221',
...
public class LookupController {
  ...
  sourceRef: 'src/analyzers/controllerLayerDetector.ts:368',
...
public class OrderController {
  ...
  sourceRef: 'src/analyzers/controllerLayerDetector.ts:232',
...
public class UserController {
  ...
  sourceRef: 'src/analyzers/apiResourceLayerDetector.ts:196',
  tags: ['dto', 'entity', 'api'],
});
...
public OrderResponse create(@RequestBody @Valid OrderRequest req) {
  ...
  sourceRef: 'src/analyzers/apiResourceLayerDetector.ts:217',
...
public class UserController {
  ...
  sourceRef: 'src/analyzers/apiResourceLayerDetector.ts:280',
...
public double discount(@RequestBody ItemRequest req) {
  ...
  sourceRef: 'src/analyzers/apiResourceLayerDetector.ts:176',
...
public class ReportController {
  ...
  configKey: 'enableDesignPatternChecks',
  relatedRules: ['RICA-V101', 'RICA-V103'],
  sourceRef: 'src/analyzers/apiResourceLayerDetector.ts:92',
  tags: ['di', 'service', 'api'],
});
...
public OrderResponse get(@RequestParam @Positive long id) {
  ...
  sourceRef: 'src/analyzers/apiResourceLayerDetector.ts:259',
...
public InvoiceResponse getInvoice(@PathVariable long id) {
  ...
  sourceRef: 'src/analyzers/apiResourceLayerDetector.ts:238',
...
public class OrderController {
  ...
  sourceRef: 'src/core/dependencyGraph.ts:549',
...
public class OrderController {
  ...
  sourceRef: 'src/core/dependencyGraph.ts:732',
...
public class UserController {
  ...
  relatedRules: ['RICA-V201', 'RICA-V202'],
  sourceRef: 'src/core/dependencyGraph.ts:644',
...
d({
  ...
  relatedRules: [],
  sourceRef: 'src/analyzers/crossFileAnalyzer.ts:32',
...
// presentation/UserController.java calls the service (allowed direction)`,
  ...
  sourceRef: 'src/analyzers/packageBoundaryDetector.ts:63',
...
public class SnsNotificationAdapter implements NotificationPort {
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:242',
...
public class PricingService { ... }`,
  ...
  configKey: 'enableDesignPatternChecks',
  relatedRules: ['RICA-V104'],
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:337',
...
// strategy chosen via arithmetic map: Map<OrderType, PricingStrategy>`,
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:374',
...
// services inject PaymentGateway`,
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:283',
...
public class Registry {
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:140',
...
public class ReportService {
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:94',
...
// Option B: add a real second implementation and keep the interface`,
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:162',
...
d({
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:535',
...
d({
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:664',
...
d({
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:691',
...
d({
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:736',
...
d({
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:767',
...
d({
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:795',
...
d({
  ...
  configKey: 'enableDesignPatternChecks',
  relatedRules: ['RICA-V305'],
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:825',
...
d({
  ...
  configKey: 'enableDesignPatternChecks',
  relatedRules: ['RICA-V303'],
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:848',
...
d({
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:879',
...
d({
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:938',
...
d({
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:965',
...
d({
  ...
  configKey: 'enableDesignPatternChecks',
  relatedRules: ['RICA-V101', 'RICA-V103'],
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:1005',
...
d({
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:1044',
...
public class OrderService {
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:970',
...
class Square extends Shape { Square(Color c){super(c);} void draw(){ color.apply(); /* square */ } }`,
  ...
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:1030',
...
d({
  ...
  relatedRules: [],
  sourceRef: 'src/analyzers/designPatternAnalyzer.ts:70',
...
d({
  ...
  relatedRules: [],
  sourceRef: 'src/core/violationManager.ts:77',
...
export const VIOLATION_CATALOG: readonly ViolationDoc[] = Object.values(CATALOG_BY_CODE)
  .sort((a, b) => a.code.localeCompare(b.code));

/** Lookup by code (e.g. 'RICA-V401'). */
export const VIOLATION_DOC_BY_CODE: Readonly<Record<string, ViolationDoc>> = CATALOG_BY_CODE;

/**
 * Relative documentation slug for a code, e.g. 'RICA-V101' → '/violations/RICA-V101'.
 * Returns undefined for unknown codes.
 */
export function violationDocSlug(code?: string): string | undefined {
