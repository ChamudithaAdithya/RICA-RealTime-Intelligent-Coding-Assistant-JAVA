import { ServiceLayerAnalyzer, ServiceLayerViolation } from '../analyzers/serviceLayerDetector';
import { ControllerLayerAnalyzer, ControllerLayerViolation } from '../analyzers/controllerLayerDetector';
import { EntityLayerAnalyzer, EntityLayerViolation } from '../analyzers/entityLayerDetector';
import { APIResourceLayerAnalyzer, APIResourceLayerViolation } from '../analyzers/apiResourceLayerDetector';
import { CrossFileAnalyzer } from '../analyzers/crossFileAnalyzer';
import { buildGraphFromFiles, patchGraphForFile, ProjectDependencyGraph } from './dependencyGraph';
import { PackageBoundaryAnalyzer } from '../analyzers/packageBoundaryDetector';
import { DESIGN_PATTERN_RULE_TYPES, DesignPatternAnalyzer, DesignPatternRuleType } from '../analyzers/designPatternAnalyzer';
...
export class ViolationManager {
    ...
    public clear(): void {
        ...
        this.filesMap = {};
        this.graph = new ProjectDependencyGraph();
